...
public class TakingTurnsQueueTests
{
    ...
    // Defect(s) Found: the error is that the method is inserting the person(element) at the from not adding at the back hence 'Sue' instead of 'Bob'
    ...
    // Run 10 times.
    // Expected Result: Bob, Tim, Sue, Bob, Tim, Sue, Tim, Sue, Tim, Tim
    // Defect(s) Found:tim not handled as an infinite turn
